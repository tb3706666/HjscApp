...
var itemsdata = [
				...
				{imgurl:'icon/gl5.png',name:'对话',zt: false,appurl:'javascript:void(0)'},
				{imgurl:'icon/gl6.png',name:'会议',zt: false,appurl:'javascript:void(0)'},
				{imgurl:'icon/gl7.png',name:'虚拟场景',zt: true,appurl:'../at_team/Space_container.html'},
				{imgurl:'icon/gl8.png',name:'工程日历',zt: false,appurl:'javascript:void(0)'},
				{imgurl:'icon/gl9.png',name:'工程任务',zt: false,appurl:'javascript:void(0)'},
